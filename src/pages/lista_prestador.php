...
<head>
    ...
    <title>Job4You ADM - Lista de Prestadores</title>
    <!-- Tailwind CSS -->
...
<body class="bg-gray-100">
        ...
        <div class="main-content w-full">
            ...
            <main class="p-6">
                <div class="bg-white rounded-lg shadow-md p-6">
                    <h1 class="text-2xl font-bold text-gray-800 mb-6">Lista de Prestadores Cadastrados</h1>
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                        ...
                        <div class="relative w-full md:w-64">
                            <input type="text" id="searchInput" placeholder="Buscar prestador..." 
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody id="prestadoresTableBody" class="bg-white divide-y divide-gray-200">
                    ...
                    <div class="flex justify-between items-center mt-6">
                        <div class="text-sm text-gray-700">
                            Mostrando <span id="startItem">1</span> a <span id="endItem">10</span> de <span id="totalItems">0</span> prestadores
                        </div>
    ...
    <div id="approvalModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-lg p-6 w-full max-w-md">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-xl font-bold">Aprovar Prestador</h3>
            ...
            <div id="approvalModalContent">
                <p id="approvalText">Deseja aprovar este prestador?</p>
    ...
    <!-- JavaScript Separado -->
    <script src="admin_prestadores.js"></script>
</body>
</html>