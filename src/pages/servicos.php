...
<body>
 <!-- Navbar (Menu de Navegação) -->
  ...
  <header class="text-center py-5 bg-light">
    <div class="container">
      <h1 class="fw-bold">Encontre Serviços Informais em Diversas Categorias</h1>
      <p class="lead">Pesquise pela categoria do serviço que você precisa</p>
      <div class="row justify-content-center mt-4">
        <div class="col-md-6">
          <div class="input-group">
            <input type="text" class="form-control" placeholder="Pesquisar categoria...">
  ...
  <section class="py-5 bg-white">
    <div class="container">
      <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <!-- Repetição para cada categoria (cards) -->
        <div class="col">
          <div class="card h-100 text-center">
            <div class="card-body">
